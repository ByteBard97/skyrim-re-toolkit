...
| v0.2 — Other runtimes (SE 1.5.97, AE 1.7.99, VR, GOG) | In progress | SE 1.5.97 and VR 1.4.15 validated layout-wise against their own headers' `static_assert`s (see `type-importer/RUNTIME_SE_1_5_97.md`, `RUNTIME_VR_1_4_15.md`); both wired into CI as a matrix job. AE 1.7.99/GOG and Address Library address cross-checks not started |
