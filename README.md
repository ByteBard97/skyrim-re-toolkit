...
**[→ Download AE/SE/VR `.gdt` files from the `gdt-v3` release](https://github.com/ByteBard97/skyrim-re-toolkit/releases/tag/gdt-v3)** — no build required. Import into Ghidra via **File → Add Archive**.
...
1. [Download `gdt-v3`](https://github.com/ByteBard97/skyrim-re-toolkit/releases/tag/gdt-v3) (AE/SE/VR).
