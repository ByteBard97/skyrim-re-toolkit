...
| v0.2 — Other runtimes (SE 1.5.97, AE 1.7.99, VR, GOG) | In progress | SE 1.5.97 validated layout-wise against its own headers' `static_assert`s (see `type-importer/RUNTIME_SE_1_5_97.md`); AE 1.7.99/VR/GOG and Address Library address cross-checks not started |
