...
**[→ Download AE/SE/VR `.gdt` files from the `gdt-v2` release](https://github.com/ByteBard97/skyrim-re-toolkit/releases/tag/gdt-v2)** — no build required. Import into Ghidra via **File → Add Archive**.
...
1. [Download `gdt-v2`](https://github.com/ByteBard97/skyrim-re-toolkit/releases/tag/gdt-v2) (AE/SE/VR).
